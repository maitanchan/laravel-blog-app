...
class PostController extends Controller
{
    ...
    public function home(): View
    {
        ...
        //Popular 5 Posts (based on user like) 
        ...
        // If authorized - Show recommended 3 posts based on user like
        $user = auth()->user();
        ...
        if ($user) {
            ...
            //Not authorized - Popular 3 posts based on views
            $recommendedPosts = Post::query()
    ...
    public function show(Post $post, Request  $request)
    {
        ...
        return view('post.view', compact('post', 'prev', 'next', 'popularPosts', 'randomPosts'));
    }
